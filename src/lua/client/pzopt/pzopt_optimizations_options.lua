...
local SECTIONS = {
    ...
    {
        title = "HDR output (Linux with an HDR screen: Wayland desktop with HDR on, e.g. KDE Plasma 6; Windows and macOS later)", clip = "nightdrive",
        entries = {
            { key = "hdr", label = "HDR output",
              tip = "The game is shown as HDR: the menus and the HUD stay at your desktop's white, lamps, torches, headlights, fires and lightning go above it up to your screen's peak. Needs an HDR screen with HDR switched on in the desktop settings; on Linux the game then runs as a native Wayland window. Without an HDR screen, or on Windows and macOS for now, nothing changes. Applies on the next launch." },
            ...
            { key = "hdrBloomPct", label = "HDR: glow around bright light (%)",
              ...
              tip = "The light the HDR highlights add also spills a little into the dark around them, the way a bright lamp glows in the eye. Costs about 0.2 ms a frame at 4K." },
            { key = "hdrSunPct", label = "HDR: sunlight (%)",
              choices = { "0", "30", "60", "100" }, note = { ["0"] = "daylight as in the SDR game", ["60"] = "default" },
              tip = "On a clear day the sunlit outdoors is shown brighter than the SDR picture by this much, less with the sun low or behind clouds; shade and interiors stay as they are." },
            { key = "hdrGlintPct", label = "HDR: sparkle on water and puddles (%)",
              ...
              tip = "The sun glitters on rivers, lakes and puddles above the desktop's white, the sky reflects in them, and at night lamps, torches and headlights glint on the water." },
            { key = "hdrPaperPct", label = "HDR: world brightness (% of the desktop's white)",
              ...
              tip = "The brightness of the world's ordinary (unlit by lamps) surfaces relative to your desktop's white. Lower leaves more room above it for the highlights: they look brighter by contrast." },
            { key = "hdrItmPct", label = "HDR: bright pixels at night become highlights (%)",
              choices = { "0", "25", "50", "100" }, note = { ["0"] = "off" },
              tip = "At night, pixels that are already near white (lit windows, bright signs) are also pushed above the desktop's white. Off in daylight." },
            { key = "hdrSaturationPct", label = "HDR: extra colour (%)",
              choices = { "0", "5", "10", "20" }, note = { ["0"] = "the game's colours" },
              tip = "A little more colour saturation, using the wider colour range of HDR screens." },
            { key = "hdrPeakNits", label = "HDR: brightest highlight (nits)",
              ...
              tip = "Caps the brightest highlight below what the screen can do, if the peaks are too much." },
            { key = "hdrUiNits", label = "HDR: menu and HUD white (nits)",
              ...
              tip = "The brightness of the menus and the HUD. By default the desktop's own white, so switching windows does not change brightness." },
        },
    },
    {
