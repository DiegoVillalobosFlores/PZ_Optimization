...
public final class Config {
   ...
   public static final int GL_NAME_POOL = Math.max(8, integer("glNamePool", 64)); // glNoSync: texture names kept ready
   ...
   public static String describe() {
      return "parallel=" + PARALLEL + " workers=" + WORKERS + " (effective " + effectiveWorkers() + ", cores "
            ...
            + " uniformCache=" + UNIFORM_CACHE + " compositeShaderRun=" + COMPOSITE_SHADER_RUN + " ambientOcclusion=" + AO + " aoMode=" + AO_MODE + " aoScalePct=" + AO_SCALE_PCT + " aoRadiusPct=" + AO_RADIUS_PCT + " aoStrengthFloorPct=" + AO_STRENGTH_FLOOR_PCT + " aoStrengthWallPct=" + AO_STRENGTH_WALL_PCT + " aoStrengthObjectPct=" + AO_STRENGTH_OBJECT_PCT + " aoStrengthVegetationPct=" + AO_STRENGTH_VEGETATION_PCT + " aoThicknessPct=" + AO_THICKNESS_PCT
