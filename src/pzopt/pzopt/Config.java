...
public final class Config {
   ...
   public static final boolean DLSS_DIRECT_COLOR = bool("dlssDirectColor", false); // dlss: the world pass draws straight into the DLSS colour image (its colour attachment swapped for the frame) instead of a copy at the resolve
