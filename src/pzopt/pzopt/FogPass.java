...
public final class FogPass {
   ...
   public static void sceneDepthAsTexture(zombie.core.textures.TextureFBO fbo, Texture tex) {
      if (!Overrides.enabled() || !(Config.FOG_PASS || Config.AO && "screen".equals(Config.AO_MODE) || Config.PIXEL_LIGHT) || Config.FOG_DEPTH_COPY || fbo == null) { // ambient occlusion reads it in place too
         return;
      }
